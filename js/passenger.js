...
$('#head-passenger li').click(function(){
    ...
    field1 = this.id;
    $('#data').load('modules/passenger.php',{id:id, field1:field1, trend1:trend1,trend2:trend2});
...
$('#head-ticket li').click(function(){
    ...
    field2 = this.id;
    $('#data').load('modules/passenger.php',{id:id, field2:field2, trend2:trend1, trend2:trend2});
